...
enum Command
{
	...
	COMMAND_THROTTLE = 2006,
	COMMAND_THROTTLE2 = 2005,
	COMMAND_THROTTLE_ALL = 2004,

	COMMAND_ENGINES_START = 309,
	COMMAND_ENGINES_STOP = 310,
	COMMAND_ENGINE_START1 = 312,
	COMMAND_ENGINE_START2 = 311,
	COMMAND_ENGINE_STOP1 = 314,
	COMMAND_ENGINE_STOP2 = 313,
	...
	COMMAND_NOSEWHEEL_STEERING = 2003, //Neu aus Konsole abgelesen
...
class Input
{
	...
	public:
		...
		virtual void zeroInit()
		{
			...
			m_finalThrottle1 = 1.0;
			m_finalThrottle2 = 1.0;
		...
		inline const void nwSteering(double value)
		{
			m_nwsteering = value;
			//return m_nwsteering;
		}
