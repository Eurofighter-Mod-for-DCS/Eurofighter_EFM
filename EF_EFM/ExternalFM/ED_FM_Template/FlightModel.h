...
{
public:
	FlightModel(State& state, Input& input, Engine& engine, Airframe& airframe, Fuelsystem& fuelsystem, Flight_Control_System& fcs); //Fuelsystem& fuelsystem zugefügt 30Jan22
...
bool FlightModel::getWingstall()
{
	return m_wingStalling;
}
